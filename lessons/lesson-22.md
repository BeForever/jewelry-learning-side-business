...
1. 颜色和净度都会影响钻石价格，但不一定都需要追求最高。
2. 肉眼效果、镶嵌金属颜色和预算会影响颜色选择。
3. 净度要关注内含物类型、位置、大小和是否肉眼可见。
4. 钻石购买应在预算内综合克拉、颜色、净度、切工和证书。
...
D-Z 等级 是这一课的核心观察点之一。学习时要把它放到具体品类、预算和证书语境中理解；看预算和镶嵌，但不能把单一信息点直接升级成鉴定、估价或产地结论。

### 1.4 净度

内外部特征 是这一课的核心观察点之一。学习时要把它放到具体品类、预算和证书语境中理解；看肉眼可见，但不能把单一信息点直接升级成鉴定、估价或产地结论。

### 1.5 取舍

不要盲目拉满 是这一课的核心观察点之一。学习时要把它放到具体品类、预算和证书语境中理解；用途优先，但不能把单一信息点直接升级成鉴定、估价或产地结论。
...
> 高色高净价格更高，但不一定最适合所有预算；应结合肉眼效果、切工、大小、证书和佩戴需求。
...
- 已准备自媒体素材：
  ...
  - 分屏视频脚本。
  - 6 页图文轮播稿。
- 学完本课后的下一课建议：第 23 课：钻石荧光、奶咖绿、证书备注与隐藏风险。
